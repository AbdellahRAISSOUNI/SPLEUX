...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: "Join 35,000+ academy members with 5+ years of proven trading experience.",
    label: "35K+ Members",
  },
  {
    color: "rgba(255, 255, 255, 0.02)",
    title: "Daily Insights",
    description: "Receive daily free signals and comprehensive market analysis.",
    label: "Daily Updates",
  },
];
        ...
        {`
          ...
          .card-responsive::before {
            ...
            background: linear-gradient(135deg, 
              rgba(193, 255, 114, 0.03) 0%, 
              transparent 50%, 
              rgba(193, 255, 114, 0.03) 100%);
            border-radius: 2rem;
            pointer-events: none;
            opacity: 0;
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative w-full p-6 rounded-2xl border border-solid overflow-hidden ${
